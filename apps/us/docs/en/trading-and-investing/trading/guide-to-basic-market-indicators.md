...
Example: Company A's cumulative net profit up to the third quarter is CNY 10 million, and its current shares outstanding are 20 million shares. Then, EPS (dynamic) \= 10,000,000/9 × 12/20,000,000 = CNY 0.667. This means the dynamic EPS i calculated by estimating full-year net profit based on the cumulative net profit reported in the latest financial report.

Note: For the Hong Kong (China) and A-share markets, the net profit refers to the net profit attributable to the shareholders of the parent company.

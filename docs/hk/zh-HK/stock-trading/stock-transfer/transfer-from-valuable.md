...
![](./images/Kh8Abrz1eoFKmSxIkQbjToRdpJc.png)

![](./images/CeGlbG9cHocCiSxvA6kjM8uapPe.png)
...
![](./images/SfVybxy4Bo8sDjxrmVfjxnC0p7e.png)

1. 选择转出股票对应的市场，接收方选择**其他转入方**，填写长桥接收方信息
	- **港股接收方信息（长桥）：**
	| 字段 | 内容 |
| --- | --- |
...
| 账户号码 | 您的长桥证券账户号码（H 开头） |
| 账户姓名 | 您的长桥证券账户姓名 |
	![](./images/PSyebAr5goZQBJx9Rawji00Zp7f.png)

2. 填写转出股票代码和股数，点击**下一步**，确认所有信息后提交

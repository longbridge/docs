...
![](./images/UEGYbYXLao7I5Sxw45UjU32Cpc5.png)

## 第一步：在长桥提交转入申请（两种账户相同）

1. 打开**长桥 App** → **资产** → **存入股票** → **提交转入申请**；或进入**资产 → 全部功能 → 转入股票**

![](./images/RQxEbB2n7orq7IxuDuOjpKFspHc.png)

![](./images/E6UQbXDaJo9aQzx4ySJjdje0pme.png)

1. 转出券商选择**老虎证券**，填写账户姓名和账户号码，填写股票信息后提交
...
![](./images/MuLybqYGCounizxTqBjjUQaGp4d.png)

从老虎 App 获取 IB 账号

登录 [IB 官网](https%3A%2F%2Fwww.interactivebrokers.com.hk%2Fcn%2Fhome.php)，使用该账号作为用户名（忘记密码可通过「忘记密码」找回，或致电 IB 客服 021-60868586）。登录后，在投资组合栏查看 IB 账户号（提交长桥转入申请时需要）。
...
![](./images/MuZcbWORvoKpTsxNXGXjA0F1p3e.png)

#### 美股（IB 消息中心）

1. 在 IB 账户右上角选择**帮助** → **支持中心**

![](./images/UmR8bebUkoEFo4xF3UIjAcEzpWb.png)

1. 选择**消息中心**

![](./images/ZkwCb1la9ovtPyx3RpXjmEnnpVd.png)

1. **撰写** → **新咨询单** → **Funds & Banking** → **Position Transfers**

![](./images/Gs16bhuggo3lkLxlkiAja2lKpgb.png)

![](./images/P92gbxfEKooduOxzdDajogxEpEf.png)

1. 按以下模板填写咨询单后点击 **Preview Ticket**：

![](./images/CdEXbgOrYoA6JcxgBrEjV4R6pQd.png)
...
1. 提交后 IB 会生成 ticket number，**请将该 ticket number 告知长桥客服**

2. **部分用户**会收到 IB 通知需提供授权书，按实际情况处理后提交

![](./images/Wx2Wbsp8QoPOkwxQrEPjFOwEpGa.png)

...
![](./images/WrHcb2cfNoZMLwx8Sixjp9SEpFd.png)
...
| 状态/按钮显示 | 含义 | 用户应该做什么 |
| --- | --- | --- |
| 立即兑换 | 商品有库存且满足条件,可正常兑换 | 确认任务币充足后直接兑换 |
| 去赚任务币 | 任务币余额不足 | 前往任务中心完成任务赚取任务币 |
| 已售罄 / 补货中 | 当前库存已兑完,暂时无法兑换 | 等待商城每周刷新补充库存,或关注运营补货 |
| 立即订阅 / 已提醒(预热中) | 热门商品即将开抢,显示开抢倒计时 | 点击「立即订阅」设置开抢提醒,开抢后尽快兑换 |
| 未到兑换时间 | 商品设有兑换开始时间,尚未开始 | 等待兑换开始时间 |
| 查看礼品(已达上限) | 已达到该商品本周兑换次数上限 | 等下周商城刷新后次数恢复 |
| 不满足兑换条件 | 账户未满足该商品的兑换门槛(如开户、认证等) | 按商品页提示完成相应条件 |
| 已下架 | 商品已不再提供 | 关注其他商品 |
...
商城商品每周刷新一次。每次刷新后会更新商品库存，部分商品可能更换或下架，新商品也可能上架。建议定期查看商城。

**兑换了商品后多久能到账？**

不同商品类型到账时间不同： - 卡券：通常较快到账，可在卡包中查看 - 现金/股票：到账时间视具体商品说明而定 - 实物商品：需要配送时间，以物流通知为准 - 课程：通常较快开通

如超出预期时间仍未收到，请联系客服并提供兑换记录截图。

**商品显示”补货中”是什么意思？能兑换吗？**

“补货中”表示该商品当前库存已用完，暂时无法兑换。等待商城刷新或运营补货后恢复。处于”补货中”状态的商品无法完成兑换操作。
...
任务中心页面、兑换商城页面顶部均显示当前余额;点击余额可进入任务币明细页查看每笔获得、消耗和过期记录。
...
- 兑换实物礼品后,请在 7 天内进入「已兑换商品」填写完整收件地址及联系方式,逾期未填写视为放弃领取(以活动页说明为准)

-  实物礼品将在 30 天内统一发货,可能因缺货、物流等原因延迟;如遇缺货或无法发货,平台有权以同等价值礼品替换(以活动页说明为准)

- 收货地址在发货前可修改,发货后锁定(详见《实物奖品》说明)
...
- 商品库存有限，先到先得；商城每周刷新时补充库存

- 限时折扣在活动截止后自动恢复原价，以商品页实时显示为准。折扣期间兑换的商品不受影响

...
![](./images/YMEsbVTOrohcKjxW4iFjHJWMpWd.png)
...
![](./images/MioKbYuaKozoLbxEXvUjNglqp7b.png)

1. 输入转账金额，在**备注**栏填写长桥综合账户号和姓名（如：H123456 XIAOHUA），点击**提交**
	- 填写备注有助于长桥快速匹配入账。

![](./images/H1dobAeVvoe9nSxReuWjjt2YpZe.png)

1. 核对所有资料，点击**确认**，转账完成

![](./images/YlRqbWbDaotDgxxlPfPj2ed1phg.png)

1. 立即截图保留凭证，返回**长桥 App** → **资产** → **存入资金** → **网银转账**，上传凭证
	- 凭证必须在汇款完成后立即上传，否则影响入金进度

![](./images/UVidbbhlGorPazxvRmRjfLv3psI.png)

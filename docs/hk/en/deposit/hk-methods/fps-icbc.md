...
![](./images/UgAKbHv5couhilxH0MvjE0Bbpdb.png)

1. 在工银亚洲发起转账（选择其中一种方式）：
	- **方式一：工银亚洲 App**
		- 打开**工银亚洲 App** → **全部** → **转账支付** → **e 秒转-FPS** → **付款**，填写扣款账户和转账金额，确认后完成转账
		![](./images/YAI1bbkYeoLsZgxWjt5jiV5ppIb.png)
		![](./images/LBHYbqlFoo3iJPxCOcLjRVnHprb.png)
	- **方式二：网上银行**
		- 登入网上银行 → **账户服务** → **转账汇款** → **本地转账**，填写转账信息后提交
		![](./images/AiyYbIBP9oDLsfxo5i7jGyespql.png)

2. 转账完成后，立即返回**长桥 App** → **资产** → **存入资金** → **FPS 转数快**，上传汇款转账凭证
	- 凭证必须在转账后立即上传，否则影响入金进度

![](./images/KpUNbFYOvoSCFYx9i5sj6QPzpfb.png)

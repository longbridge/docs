...
![](./images/SiU4bBvIxoULWyxYGdPjq8Uppfg.png)
...
![](./images/PJo4bV4KxoCxMhx7yvGjwQvVphc.png)

选择网格交易订单类型

**步骤 2**：按界面提示输入价格和数量参数后提交策略。

![](./images/XOLxbk70xoBTbFx3YRpjwFdEpzu.png)

填写网格策略参数

**步骤 3**：提交完成后，在个股详情页可看到对应网格策略记录，点击可进入策略单详情。资产首页或订单记录页也可查看策略订单及交易盈亏情况。如需暂停监控或撤销，可点击策略单选择暂停或撤销；如需调整参数，可点击修改进行改单。

![](./images/IuOibGFvio2fEyxftobjKL9Op1e.png)

网格策略订单记录

![](./images/HV1YbFbVQopTlBxzFlpjI4gRpub.png)

网格策略详情页

![](./images/KRkYb8BpbobiKXxUtDhjQSxGpsd.png)

网格策略盈亏展示

### 桌面端（Longbridge Pro）

![](./images/EwOXbZ3Caof9YWxBMSBjZJ68pod.png)
...
![](./images/H96FbzwJVoGBjTxfWf3jZfWPpnh.png)
...
触发后委托类型： - 市价（市价单）：以当时市场行情决定成交价 - 市价（限价单）：以触发时市价为限价，成交价优于或等于限价 - 触发价（限价单）：以设定触发价为限价
...
示例：基准价 170，每笔数量 10 股，间隔 1 元，股价跳至 175： - 开启倍数委托：(175 - 170) ÷ 1 × 10 = 50 股卖出 - 关闭倍数委托：固定卖出 10 股
